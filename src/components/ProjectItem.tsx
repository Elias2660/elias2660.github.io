...
export default function ProjectItem(props: ProjectItemProps) {
    return (<div className="w-[90vw] h-[30rem] md:h-[15rem] m-2 border-2 border-black dark:border-white rounded-sm grid grid-cols-12 grid-rows-12">
        ...
        <div className="group col-start-9 md:col-start-6 col-span-full md:col-span-full row-start-12 md:row-start-11 row-span-3">
            <a target="_blank" className="flex flex-row align-middle items-center" href={props.link}>
