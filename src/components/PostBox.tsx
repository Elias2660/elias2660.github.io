...
export default function PostBox(props:PostBoxProps) {
    return (<div className="w-[90vw] h-[50vh] md:h-[30vh] m-2 border-2 border-black dark:border-white rounded-sm grid grid-cols-12 grid-rows-12">
        ...
        <div className={`p-4 md:p-0 col-start-1 md:col-start-5 col-span-full row-start-9 ${props.title.length > 20? "md:row-start-5": "md:row-start-6"} row-span-8`}>
            <p className="text-base md:text-base lg:text-xl font-light">
                {props.description}
            </p>
        </div>

        <div className="group col-start-8 md:col-start-5 col-span-full md:col-span-full row-start-11 md:row-start-11 row-span-3">
